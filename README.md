...
1. Perform controlled hybridizations among contrasting *Vinca* accessions.
2. Develop F₁ and F₂ segregating populations.
3. Characterize ornamental traits using standardized descriptors.
4. Evaluate segregation patterns for key ornamental traits.
5. Identify inheritance patterns relevant to ornamental breeding.
